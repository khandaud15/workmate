...
export default function JobSearchInterface() {
  ...
  const commonJobTitles = [
    ...
    'network engineer',
    'neuroscientist',
    'next-generation sequencing (ngs) analyst',
    'night auditor',
    'nuclear engineer',
    'nurse anesthetist',
    'nurse practitioner',
    ...
    'sr. bioinformatics scientist - cell free dna applications',
    'sr. bioinformatics scientist - novel cell free dna technology development',
    'staff accountant',
    'staff scientist',
    'statistician',
    'stenographer',
  ...
  return (
    <div className="w-full max-w-full space-y-4 px-0.5 sm:px-0 mt-16 sm:mt-6 min-h-screen overflow-x-hidden">
      ...
      <div className="bg-[#1a2332] rounded-lg border border-[#2a3441] p-4 w-full max-w-full">
        <div className="flex flex-col md:flex-row gap-3 md:gap-2 md:items-center w-full max-w-full">
          ...
          <div className="w-full md:flex-[3] relative">
            ...
            {showSuggestions && jobSuggestions.length > 0 && (
              <div className="absolute top-full left-0 right-0 mt-1 bg-[#2a3441] border border-[#3a4651] rounded shadow-xl z-[100] max-h-64 overflow-y-auto w-full min-w-[250px]">
