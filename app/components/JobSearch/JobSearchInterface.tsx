...
export default function JobSearchInterface() {
  ...
  return (
    <div className="w-full space-y-4 px-4 sm:px-0 mt-6">
      ...
      <div className="bg-[#1e2d3d] rounded-lg border border-[#2a3441] p-4">
        <div className="flex gap-2 sm:gap-4 items-center">
          ...
          <div className="flex-[2] sm:flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[#2a3441] text-white text-sm placeholder-gray-400 border border-[#3a4651] rounded focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/20"
            />
          ...
          {/* Location Input */}
          <div className="flex-1 sm:w-64 sm:flex-none relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <button 
            ...
            className={`px-4 py-2.5 rounded transition-colors flex items-center gap-2 text-sm font-medium ${
          ...
          {/* Filter Button */}
          <button className="px-4 py-2.5 bg-[#2a3441] hover:bg-[#3a4651] text-gray-300 hover:text-white border border-[#3a4651] rounded transition-colors flex items-center gap-2 text-sm font-medium">
