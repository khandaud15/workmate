    ...
    <div className="bg-white text-gray-800 font-sans selection:bg-blue-200 p-4 md:p-6" style={{ width: '100%', minHeight: '11in' }}>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 mb-8">
        <div className="flex flex-col items-center md:items-start text-center md:text-left flex-grow">
          ...
          <p 
            ...
            suppressContentEditableWarning={true}
          >
            {coverLetterData.applicantTitle}
          </p>
          <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-gray-600 text-sm md:text-base font-medium">
            ...
            >
              ...
              {coverLetterData.applicantPhone}
            </div>
            <div 
              className="flex items-center gap-2" 
              contentEditable={isEditable}
            ...
            >
              ...
              {coverLetterData.applicantEmail}
            </div>
            <div 
              className="flex items-center gap-2" 
              contentEditable={isEditable}
            ...
            >
              ...
              {coverLetterData.applicantLinkedin}
            </div>
            <div 
              className="flex items-center gap-2" 
              contentEditable={isEditable}
            ...
            >
              ...
              {coverLetterData.applicantLocation}
            </div>
          </div>
        </div>
      ...
      <div className="text-gray-800 text-base leading-relaxed">
        ...
        <p 
          ...
          suppressContentEditableWarning={true}
        >
          {coverLetterData.recipientSalutation}
        </p>

        {coverLetterData.bodyParagraphs.map((paragraph: string, index: number) => (
          <p 
            key={index} 
            className="mb-6" 
            contentEditable={isEditable}
        ...
        {/* Closing salutation and signature removed as requested */}
      </div>
    </div>
  );
};
