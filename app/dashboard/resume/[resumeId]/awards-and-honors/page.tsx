    ...
    <DashboardLayout>
      <div className="overflow-y-auto pt-4 lg:pt-0 bg-[#0a192f] min-h-screen w-full">
        <div className="max-w-7xl mx-auto px-1 sm:p-4 md:p-8 lg:p-10">
          ...
          <ResumeNameDropdown resumeId={resumeId} currentSection="awards-and-honors" />

          {/* Navigation Buttons */}
          <ResumeNavigation resumeId={resumeId} currentSection="awards-and-honors" />
