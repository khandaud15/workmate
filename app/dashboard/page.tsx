        ...
        >
          ...
          <div className="top-section">
            ...
            <div className="menu-group">
              ...
              <button 
                type="button" 
                className={`menu-item w-full text-left ${showDashboard ? 'active' : ''}`}
                onClick={() => {
              ...
              <button 
                type="button" 
                className={`menu-item w-full text-left ${showResume ? 'active' : ''}`}
                onClick={() => {
              ...
              <button 
                type="button" 
                className={`menu-item w-full text-left ${showCoverLetter ? 'active' : ''}`}
                onClick={() => {
                  setShowDashboard(false);
                  setShowResume(false);
              ...
              <button 
                type="button" 
                className={`menu-item w-full text-left ${showJobTracker ? 'active' : ''}`}
                onClick={() => {
                  setShowDashboard(false);
                  setShowResume(false);
                  setShowCoverLetter(false);
              ...
              <button 
                type="button" 
                className={`menu-item w-full text-left ${showCopilot ? 'active' : ''}`}
                onClick={() => {
                  setShowDashboard(false);
                  setShowResume(false);
                  setShowCoverLetter(false);
