...
export default function KeyQuestionsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fefcf9] pb-28">
      {/* Progress Bar */}
      <div className="mx-auto max-w-4xl px-0 sm:px-6 lg:px-8 pt-8 w-full">
        <div className="relative">
          {/* Progress Lines */}
          <div className="absolute left-0 right-0 top-4">
            {/* Line between Step 1 and 2 */}
            <div className="absolute left-[calc(16.666%)] right-[calc(50%)] h-1 rounded-full bg-gray-200">
              <div className="h-full w-full rounded-full bg-[#0e3a68]"></div>
            </div>
            {/* Line between Step 2 and 3 */}
            <div className="absolute left-[calc(50%)] right-[calc(16.666%)] h-1 rounded-full bg-gray-200"></div>
          </div>
      ...
      <div className="mx-auto max-w-4xl px-0 sm:px-6 lg:px-8 mt-8 w-full">
        <div className="bg-white rounded-lg border border-black p-5 sm:p-6 mb-8 transform hover:translate-y-[-2px] transition-transform">
          <h1 className="mb-3 text-3xl font-bold text-[#1a2b4b] text-center">Key questions</h1>
          <p className="mb-2 text-[#1a2b4b] text-center">
            These are the questions that will help us best auto-fill your applications.
          </p>
          <p className="mb-8 text-sm italic text-red-500 text-center">
            * marks required fields.
          </p>

          <form className="space-y-5 mx-auto max-w-2xl">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 max-w-4xl w-full">
