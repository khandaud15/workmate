    ...
    <div className="flex min-h-screen flex-col items-center justify-start pt-24">
      <div className="w-full max-w-[400px] space-y-6">
        ...
        <div className="space-y-6">
          ...
          <button
            onClick={() => signIn("google", { callbackUrl: "/onboarding", redirect: true })}
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex justify-end mt-1">
                  <Link href="/forgot-password" className="text-xs text-gray-400 hover:text-[#4292FF] transition-colors">Forgot password?</Link>
                </div>
              </div>
            </div>
            {error && (
          ...
          <p className="text-center text-[13px] text-gray-400">
            ...
            <Link href="/signup" className="text-[#4292FF] hover:text-[#237DFF] transition-colors">
              Sign Up
            </Link>
          </p>
        </div>
